...
fun RowScope.BottomItem(
    ...
    val (iconSize, offsetY) = if (screen == BottomBarDestination.ADD) Pair(48.dp, (-10).dp)
    else Pair(24.dp, 0.dp)
        ...
        label = {
            screen.title?.let {
                Text(
                    ...
                    softWrap = false,
                    color = if (isCurrentBottomItemSelected) Color.White else Color.White.copy(alpha = 0.62f)
                )
            }
        },
        icon = {
